...
/***/ function(module, exports, __webpack_require__) {
	...
	ReactDOM.render(React.createElement(PopUp, null), appElement);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Game.prototype.checkCollisions = function () {
	  ...
	  if (this.player.pos[0] < 5 || this.player.pos[0] > this.DIM_X - 5 || this.player.pos[1] < 5 || this.player.pos[1] > this.DIM_Y - 5) {
	    if (this.lifeTimer > 100) {
	      this.lifeTimer = 0;
	      this.hitCounter++;
	      this.player.setPos([this.DIM_X * 0.12, this.DIM_Y * 0.885]);
	  ...
	  if (this.player.pos[0] > 5 && this.player.pos[0] < this.DIM_X / 10 && this.player.pos[1] > 5 && this.player.pos[1] < this.DIM_Y / 9) {
	    this.gameWon = true;
	  }
	};
...
/***/ function(module, exports) {
	...
	var climbingPos = function (pos, DIM_X, DIM_Y) {
	  //level 1
	  if (pos[0] > DIM_X * 129 / 180 && pos[0] < DIM_X * 27 / 36 && pos[1] > DIM_Y * 37 / 45 && pos[1] < DIM_Y * 79 / 90) {
	    return true;
	  }
	  //level2
	  if (pos[0] > DIM_X * 0.2333 && pos[0] < DIM_X * 0.2666 && pos[1] > DIM_Y * 0.6666 && pos[1] < DIM_Y * 0.7222) {
	    return true;
	  }
	  //level3
	  if (pos[0] > DIM_X * 0.7166 && pos[0] < DIM_X * 0.75 && pos[1] > DIM_Y * 0.5277 && pos[1] < DIM_Y * 0.5833) {
	    return true;
	  }
	  //level4
	  if (pos[0] > DIM_X * 0.2333 && pos[0] < DIM_X * 0.2666 && pos[1] > DIM_Y * 0.4 && pos[1] < DIM_Y * 0.4388) {
	    return true;
	  }
	  //level5
	  if (pos[0] > DIM_X * 0.7166 && pos[0] < DIM_X * 0.75 && pos[1] > DIM_Y * 0.2222 && pos[1] < DIM_Y * 0.2766) {
	    return true;
	  }
	  return false;
	};
	...
	var move = function (pos, keystate, DIM_X, DIM_Y) {
	  ...
	  if (keystate[space]) {}
	  // level 6
	  if (yPos < DIM_Y * 0.2111 && yPos > 0 && (keystate[RightArrow] || keystate[LeftArrow])) {
	    ...
	    // level 5
	  } else if (yPos > DIM_Y * 0.2222 && yPos < DIM_Y * 0.34 && (keystate[RightArrow] || keystate[LeftArrow])) {
	      if (keystate[RightArrow]) {
	        vel = [xVel, -yVel];
	      } else if (keystate[LeftArrow]) {
	        vel = [-xVel, yVel];
	      ...
	      // level 4
	    } else if (yPos > DIM_Y * 0.3555 && yPos < DIM_Y * 0.5 && (keystate[RightArrow] || keystate[LeftArrow])) {
	        if (keystate[RightArrow]) {
	          vel = [xVel, yVel];
	        } else if (keystate[LeftArrow]) {
	          vel = [-xVel, -yVel];
	        ...
	        // level 3
	      } else if (yPos > DIM_Y * 0.5055 && yPos < DIM_Y * 0.65 && (keystate[RightArrow] || keystate[LeftArrow])) {
	          if (keystate[RightArrow]) {
	            vel = [xVel, -yVel];
	          } else if (keystate[LeftArrow]) {
	            vel = [-xVel, yVel];
	          ...
	          // level 2
	        } else if (yPos > DIM_Y * 0.6667 && yPos < DIM_Y * 0.8 && (keystate[RightArrow] || keystate[LeftArrow])) {
	            if (keystate[RightArrow]) {
	            ...
	            // level 1
	          } else if (yPos > DIM_Y * 0.81 && yPos < DIM_Y && (keystate[RightArrow] || keystate[LeftArrow])) {
	              if (keystate[RightArrow]) {
	                vel = [xVel, -yVel];
	              } else if (keystate[LeftArrow]) {
	                vel = [-xVel, yVel];
	...
	Player.prototype.move = function (keystate) {
	  if (Math.floor(this.pos[0]) >= this.DIM_X * 0.8033 && Math.floor(this.pos[0]) <= this.DIM_X * 0.9777 && this.vel[1] > 0) {
	    if (Math.floor(this.pos[1] <= this.DIM_Y * 0.7588) && Math.floor(this.pos[1] >= this.DIM_Y * 0.7255)) {
	      this.fall = true;
	    }
	    if (Math.floor(this.pos[1] <= this.DIM_Y * 0.4611) && Math.floor(this.pos[1] >= this.DIM_Y * 0.4277)) {
	      this.fall = true;
	    }
	    if (Math.floor(this.pos[1] <= this.DIM_Y * 0.1666) && Math.floor(this.pos[1] >= this.DIM_Y * 0.1111)) {
	      this.fall = true;
	    }
	  } else if (Math.floor(this.pos[0]) >= this.DIM_X * 0.0222 && Math.floor(this.pos[0]) <= this.DIM_X * 0.1888 && this.vel[1] > 0) {
	    if (Math.floor(this.pos[1] <= this.DIM_Y * 0.6111) && Math.floor(this.pos[1] >= this.DIM_Y * 0.5777)) {
	      this.fall = true;
	    }
	    if (Math.floor(this.pos[1] <= this.DIM_Y * 0.3122) && Math.floor(this.pos[1] >= this.DIM_Y * 0.2666)) {
	      this.fall = true;
	    }
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(154);
	var ReactDOM = __webpack_require__(8);
	var Modal = __webpack_require__(167);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(process) {var React = __webpack_require__(154);
	var ReactDOM = __webpack_require__(8);
	var ExecutionEnvironment = __webpack_require__(169);
	var ModalPortal = React.createFactory(__webpack_require__(170));
	var ariaAppHider = __webpack_require__(185);
	var elementClass = __webpack_require__(186);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var focusManager = __webpack_require__(171);
	var scopeTab = __webpack_require__(173);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var findTabbable = __webpack_require__(172);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var baseAssign = __webpack_require__(175),
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * Available under MIT license <https://lodash.com/license>
	 */
	var baseCopy = __webpack_require__(176),
	    keys = __webpack_require__(177);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * Available under MIT license <https://lodash.com/license>
	 */
	var bindCallback = __webpack_require__(182),
